...
public class MainCatalogController {
	...
	@Autowired
	MainCatalogServ mainCatalogServ;
	
	
	@RequestMapping(value = "/all/{langcode}", method = RequestMethod.GET)
	  public  ResponseEntity<List<MainCatalog>> getAll(HttpServletRequest request,@RequestHeader("Devicecode") String  Devicecode,@RequestHeader("username") String  username,@RequestHeader("usertokean") String  usertokean,@RequestHeader("pageid") String  pagenum,@PathVariable("langcode") String langcode) {
		...
		if(result) {
			...
			return new ResponseEntity<List<MainCatalog>>(mainCatalogServ.getall(langcode), HttpStatus.OK);
