package com.rimdev.rimauth.entities;
 ...
 */
@Entity
@Table(name = "log_warning", catalog = "rim_user", schema = "rim_user")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "LogWarning.findAll", query = "SELECT l FROM LogWarning l")
    , @NamedQuery(name = "LogWarning.findById", query = "SELECT l FROM LogWarning l WHERE l.id = :id")
    , @NamedQuery(name = "LogWarning.findByUserId", query = "SELECT l FROM LogWarning l WHERE l.userId = :userId")
    , @NamedQuery(name = "LogWarning.findByLogText", query = "SELECT l FROM LogWarning l WHERE l.logText = :logText")
    , @NamedQuery(name = "LogWarning.findByLogException", query = "SELECT l FROM LogWarning l WHERE l.logException = :logException")
    , @NamedQuery(name = "LogWarning.findByLogTime", query = "SELECT l FROM LogWarning l WHERE l.logTime = :logTime")})
public class LogWarning implements Serializable {
    ...
    public String toString() {
        return "entity.LogWarning[ id=" + id + " ]";
    }
