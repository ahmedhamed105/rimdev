...
@Entity
@Data
@Table(name = "log_other", catalog = "rim_user", schema = "rim_user")
@XmlRootElement
@NamedQueries({
...
public class LogOther implements Serializable {
    ...
    public LogOther(int userId, String logText, String logException, Date logTime, Integer deviceId, Integer logtypeID,
