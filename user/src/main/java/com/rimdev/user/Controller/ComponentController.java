...
public class ComponentController {
	...
	DevicePageServ devicePageServ;
	  ...
	  public  ResponseEntity<List<parent_comp>> getUsersbyuser(@RequestHeader("Devicetokean") String  Devicetokean,@RequestHeader("pageid") String  pagenum,@PathVariable("langcode") String langcode,@PathVariable("id") int pageid){ 
